...
//  Crawler
//
//  Created by maka.zeng on 16/3/17.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UINavigationController* crawlersNavigation = [[UINavigationController alloc]initWithRootViewController:crawlers];
    self.window.rootViewController = crawlersNavigation;
